...
import com.android.asynchttpclient.uploadimage.LoadDialog;
import com.android.asynchttpclient.uploadimage.UploadService;
...
public class UploadImageActivity extends Activity {
    ...
    protected void onStop() {
        ...
        if (requestQueue != null) {
            requestQueue.cancelAll(AndroidClient.VOLLEY_TAG);
        }
    }
    ...
    public void uploadImageClick() {
        ...
        if (TextUtils.isEmpty(uploadFile)) {
            ...
            stringRequest = new StringRequest(
                    ...
                    Request.Method.POST,
                    // 请求服务器的URL路径
                    AndroidClient.getAbsoluteUrl("BookServlet"),
